...
cylinder(d=10,h=2*thickness,center=true); //double thickness to compensate curvature
...
difference() {
  linear_extrude(h=width,center=true,convexity=4) stroke(path=path2d,endcap1="line",width=thickness);
